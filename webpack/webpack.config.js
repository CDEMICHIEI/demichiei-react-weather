  ...
  postcss(bundler) {
    return {
      default: [
        ...
        require('postcss-color-function')(), // eslint-disable-line global-require
        // Convert CSS shorthand filters to SVG equivalent, e.g. .blur { filter: blur(4px); }
        // https://github.com/iamvdo/pleeease-filters
        require('pleeease-filters')(), // eslint-disable-line global-require
        ...
        // Add vendor prefixes to CSS rules using values from caniuse.com
        // https://github.com/postcss/autoprefixer
        require('autoprefixer')({ browsers: AUTOPREFIXER_BROWSERS }), // eslint-disable-line global-require
      ],
      sass: [
        require('autoprefixer')({ browsers: AUTOPREFIXER_BROWSERS }), // eslint-disable-line global-require
      ],
